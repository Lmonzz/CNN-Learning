...
#define PWDN_GPIO_NUM     32 //Power down pin used to turn the camera on or off
#define RESET_GPIO_NUM    -1 //The reset pin, typically unused in the AI-thinker
#define XCLK_GPIO_NUM      0 //External clock signal, used by the camera to synchronize data
#define SIOD_GPIO_NUM     26 //Serial Data Input, used for I2C communication with the camera
#define SIOC_GPIO_NUM     27 //Serial Clock Input, used for I2C communication with the camera
